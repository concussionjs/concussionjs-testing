...
var nta = require("/home/concussed/concussionjs-core/apps/api/node_modules/nextera/nextera.js");
...
browser.visit("http://api.local-concussionjs.com/getPage?id=testId&pagename=testPage",function (e, browser) {
	if (browser.error )
